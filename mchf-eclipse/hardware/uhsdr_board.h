...
// BELOW ALL EXTERNALLY CONTROLLABLE DEFINES HAVE THEIR DEFAULT SETTINGS
// IF NO EXTERNAL CONFIGURATION IS USED (THIS IS THE DEFAULT BUILD CASE)
// AND IF NO AUTOMATIC RULE TAKES CARE OF THE CONFIGURATION
#ifndef UHSDR_CONFIG
...
// USE_RTTY_PROCESSOR (DEFAULT IS ON)
// CHECK AT MOST ONE IS SELECTED
#if defined(NO_USE_RTTY_PROCESSOR) && defined(USE_RTTY_PROCESSOR)
	#error "Don't define both NO_USE_RTTY_PROCESSOR and USE_RTTY_PROCESSOR, these are mutually exclusive"
#endif

// SET DEFAULT IF NOTHING IS CONFIGURED
#ifndef NO_USE_RTTY_PROCESSOR
